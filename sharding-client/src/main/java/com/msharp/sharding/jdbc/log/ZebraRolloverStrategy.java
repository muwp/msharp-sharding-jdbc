package com.msharp.sharding.jdbc.log;
...
@Deprecated
@Plugin(name = "ZebraRolloverStrategy", category = "Core", printObject = true)
public class ZebraRolloverStrategy implements RolloverStrategy {
