...
public class LoggerFactory {
    ...
    private static String DEFAULT_LOG_TYPE_PROPERTY = "msharp_jdbc.log.type";

    private static String DEFAULT_LOG_DIR_PROPERTY = "msharp_jdbc.log.dir";

    private static String DEFAULT_LOG_DIR = "/data/applogs/msharp_jdbc";
