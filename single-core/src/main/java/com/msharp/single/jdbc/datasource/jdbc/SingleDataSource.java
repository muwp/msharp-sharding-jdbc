...
import com.msharp.single.jdbc.monitor.statement.MonitorConnection;
...
public class SingleDataSource extends C3p0DataSourceAdapter implements DataSourceLifeCycle, SingleDataSourceMBean {
    ...
    public Connection getConnection() throws SQLException {
        return MonitorConnection.from(getConnection(null, null));
    }
    ...
    public Connection getConnection(final String username, final String password) throws SQLException {
        ...
        try {
            ...
            if (this.jdbcUrl != null) {
                ...
                try {
                    Cat.logEvent("SQL.Database", this.jdbcUrl, "ERROR", (String) null);
                    t.setStatus(ex);
                } finally {
                    t.complete();
                }
    ...
    private void checkJdbcUrl() {
        ...
        try {
            conn = this.getConnectionOrigin(null, null);
